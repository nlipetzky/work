...
try {
  ...
  if (rawBlob && rawBlob.length > 95000) {
    rawBlob = rawBlob.slice(0, 95000) + '...[truncated]';
  }
} catch (e) {
  rawBlob = null;
}
...
// Check both Explorium-returned name and Airtable record name to handle parent-vs-subsidiary mismatches
