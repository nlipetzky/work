// FULL REPLACEMENT — Map Reroute Fields (workflow Z6RROKx5omdfvhtn)
// Adds: fold Explorium firmographic + match-business keys into explorium_<key>
// columns so rerouted rows still carry whatever Explorium returned upstream.
...
const statusValue = qualify._finalRouting || 'rerouted_wrong_modality';
const curated = {
  id: qualify._id,
