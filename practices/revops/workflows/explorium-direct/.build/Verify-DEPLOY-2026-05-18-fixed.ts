...
const readSurfaced = node({ type: 'n8n-nodes-base.airtable', version: 2.2, config: { name: 'Read Surfaced', position: [224, 320], executeOnce: true, parameters: { operation: 'search', base: { __rl: true, mode: 'id', value: 'appYBYH3aOHhTODAw', cachedResultName: 'RevOps Surface', cachedResultUrl: 'https://airtable.com/appYBYH3aOHhTODAw' }, table: { __rl: true, mode: 'id', value: 'tblnj3YlOI3thjrXp', cachedResultName: 'Companies', cachedResultUrl: 'https://airtable.com/appYBYH3aOHhTODAw/tblnj3YlOI3thjrXp' }, filterByFormula: "{Verification Status}='surfaced'", options: { fields: ['Company Name', 'CT.gov NCT IDs'] } }, credentials: { airtableTokenApi: newCredential('may 26 all bases') } }, output: [{ id: 'recCand' }] });

const readRules = node({ type: 'n8n-nodes-base.airtable', version: 2.2, config: { name: 'Read Classification Rules', position: [448, 320], executeOnce: true, parameters: { operation: 'search', base: { __rl: true, mode: 'id', value: 'appYBYH3aOHhTODAw', cachedResultName: 'RevOps Surface', cachedResultUrl: 'https://airtable.com/appYBYH3aOHhTODAw' }, table: { __rl: true, mode: 'id', value: 'tbl1HFYzezFYs5C3k', cachedResultName: 'Classification Rules', cachedResultUrl: 'https://airtable.com/appYBYH3aOHhTODAw/tbl1HFYzezFYs5C3k' }, filterByFormula: '{Active}=TRUE()', options: { fields: ['Rule Name', 'Rule Category', 'Rule Value'] } }, credentials: { airtableTokenApi: newCredential('may 26 all bases') } }, output: [{ id: 'recRule' }] });
