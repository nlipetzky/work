    ...
    parameters: {
      ...
      queryParameters: {
        parameters: [
          ...
          { name: 'fields', value: "protocolSection.identificationModule.nctId,protocolSection.identificationModule.briefTitle,protocolSection.identificationModule.officialTitle,protocolSection.sponsorCollaboratorsModule.leadSponsor,protocolSection.sponsorCollaboratorsModule.collaborators,protocolSection.designModule.phases,protocolSection.statusModule.overallStatus,protocolSection.statusModule.studyFirstSubmitDate,protocolSection.conditionsModule.conditions,protocolSection.armsInterventionsModule.interventions,protocolSection.statusModule.startDateStruct,protocolSection.statusModule.lastUpdatePostDateStruct,protocolSection.designModule.studyType,protocolSection.designModule.designInfo.primaryPurpose,protocolSection.descriptionModule.briefSummary,derivedSection.interventionBrowseModule.meshes,derivedSection.conditionBrowseModule.meshes,protocolSection.designModule.enrollmentInfo.count,protocolSection.statusModule.primaryCompletionDateStruct.date,protocolSection.statusModule.whyStopped,protocolSection.oversightModule.isFdaRegulatedDrug,protocolSection.identificationModule.secondaryIdInfos,protocolSection.contactsLocationsModule.locations.country,protocolSection.contactsLocationsModule.overallOfficials" }
        ]
      },
      options: {
