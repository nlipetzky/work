...
// Accent tokens for inline styles + Tailwind classes. Mirrors the wireframe
// rotation (blue / amber / purple). Pre-resolved so components don't reach
// across files when applying the active mode's color.
export const ACCENT_TOKENS: Record<
  ModeFeatures["accent"],
  { bg: string; text: string; border: string }
> = {
  blue: {
    bg: "rgba(91,157,255,0.15)",
    text: "rgb(91,157,255)",
    border: "rgba(91,157,255,0.50)",
  },
  amber: {
    bg: "rgba(220,150,0,0.15)",
    text: "rgb(180,110,0)",
    border: "rgba(220,150,0,0.50)",
  },
  purple: {
    bg: "rgba(120,90,200,0.15)",
    text: "rgb(95,55,180)",
    border: "rgba(120,90,200,0.50)",
  },
};
