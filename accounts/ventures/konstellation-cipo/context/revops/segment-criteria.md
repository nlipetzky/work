...
governed segment-criteria artifact is distilled FROM this. Do not treat this file as the deliverable.

TASK: Produce the account-level segment criteria for CIPO's cold-outreach list (source-agnostic: no provider/column names).
