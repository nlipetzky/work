...
governed enrichment-spec artifact is distilled FROM this. Do not treat this file as the deliverable.

TASK: Produce the enrichment spec: which data points to collect per account/contact and which are qualify-gates vs enrich-only.
