# Claude Design brief — Shadow CIPO website
...
> Rebrand note (2026-06-30): the brand is now **Shadow CIPO** (was "Konstellation
> CIPO"). Use "Shadow CIPO" as the wordmark/brand everywhere. The site still lives at
> KonstellationAI.com for now (domain is unconfirmed — don't hard-code it).

---

## 0. The brand: Shadow CIPO

**Shadow CIPO = your behind-the-scenes Chief IP Officer.** The concept rides on
"Shadow CEO" — the seasoned operator who quietly does the things a founder can't do
themselves and makes them look great doing it. Shadow CIPO does that for intellectual
property: the founder stays in the light (running the company, raising the round); the
Chief IP Officer is the capable operator in the background making their IP airtight and
their investor story strong.

Two hard framing rules for this brand:
- **Always pair the name with a literal gloss.** Cold founders don't know what "CIPO"
  is and "shadow" alone is ambiguous. Wherever the brand appears prominently, ground it
  immediately, e.g. wordmark "**Shadow CIPO**" with the line "*your behind-the-scenes
  Chief IP Officer*." Be literal so people know exactly what it is.
- **"Shadow" = capable operator in your corner, never covert/opaque/sketchy.** This is a
  trust brand. Confidence and discretion, not secrecy or noir. The metaphor is leverage
  ("someone great handling this so you don't have to"), not concealment.

This concept is a design gift: "founder in the light, the CIPO as the capable shadow"
is a real, ownable visual idea. Lean into it tastefully (see §3).

---

## 1. What this is

**Shadow CIPO** is a *fractional Chief IP Officer* service for venture-backed startups.
The model: an AI intelligence layer runs the IP analysis (freedom-to-operate, prior
art, landscape, competitor filings); a human Chief IP Officer (Will Rosellini, 15 years
in IP monetization) turns that analysis into strategy and the investor narrative. Sold
as a continuous subscription, replacing unpredictable hourly IP-firm billing.

**Audience:** founders/CEOs of venture-backed, technology-differentiated **medical-device
/ biotech / deep-tech** companies, typically Series A, raising or preparing to raise,
where IP is material to valuation. A primary, sharpened segment: **NIH SBIR/STTR Phase II
grant recipients** — many carry **TABA** (technical & business assistance) funds written
into the grant that can pay for exactly this kind of IP/commercialization work. The
**principal investigator (PI)** named on the grant is usually the founder/buyer. They are
technical, skeptical, busy; they respond to precision and credibility, not hype.
(Audience context for your design judgment — do not add unsourced NIH/TABA claims to the
page copy.)

**The site's single job (lead-gen):** get the visitor to **request a Competitor Filing
Teardown** — a custom, 1:1 piece of work ("tell us your top competitor, we'll research
...
2. **Never call Will an `attorney`, `lawyer`, or `counsel`,** or imply a current law
   license. His title is **"Chief IP Officer"** / **"fractional Chief IP Officer"** /
   **"Shadow CIPO"** only.
...
5. **No space / astronomy / "constellation" visual motifs.** No starfields, orbits,
   galaxies, night-sky gradients, connected-dots-as-stars. Explicit refusal. (Note: a
   confident "shadow/light" treatment is welcome and is NOT the same as a starfield.)
6. **"Shadow CIPO" is always glossed and never sinister** (see §0). No spy/noir/hooded
   clichés, no "dark web" energy. Discreet and capable, not covert.
7. **Keep the DRAFT banner** at the very top: "DRAFT — staging preview. Copy pending
   Will sign-off; pricing and visual identity not yet approved." (Unobtrusive top strip;
   removed at launch.)
8. **This is a strategy/judgment service, not legal representation** — that line stays
...
The visual identity will be reviewed by the expert. Execute **one strong, coherent
direction** as a candidate, with the taste to swap the accent later. Don't over-commit
to a logo.
...
top-tier boutique advisory: serious, precise, confident. Matches the curated "Legal
Services → Trust & Authority + Minimalism, Swiss Modernism 2.0" and "Editorial Grid /
Magazine" patterns.

**Lean into the Shadow CIPO concept:** "founder in the light, the CIPO as the capable
shadow." This justifies confident use of deep tone and contrast — e.g. a **dark,
authoritative hero** (deep navy/ink) resolving into clean light reading sections, or
restrained light/shadow interplay and depth. Tasteful and editorial, never noir-gimmick.

**Color (recommended candidate):** deep navy ink + warm paper + a single restrained
authority accent (brass/gold reads "established," not generic-SaaS blue).
- Ink / primary: `#0F172A` (can go deeper, e.g. `#0B1220`, for the shadow-hero)
- Secondary text: `#334155`  ·  Muted: `#64748B`
...
Light-mode-first overall; a dark hero section is encouraged. One accent only — no
rainbow, no gradients-as-decoration.

**Typography:** serif display for authority + clean sans for body + (optional) mono for
labels/data (reinforces the "precision / analysis" angle).
- Display/headings: an editorial serif — **Source Serif 4** or **EB Garamond** (avoid
  Playfair; too fashion). Big, tight, confident.
- Body/UI: **Inter** (400–600).
- Labels / eyebrows / step numbers / "[pricing pending]" / tags: a mono — **IBM Plex
  Mono** or **JetBrains Mono**, uppercase, tracked. Use it to make the numbered steps
  and eyebrows feel designed, not like artifacts.
...
**Layout & components:**
- Real above-the-fold **hero**: brand + literal gloss, eyebrow (mono) → the promise as
  the dominant typographic element → subhead → one primary CTA button → a quiet proof
  strip. (Shadow-hero treatment encouraged here.)
- Clear section rhythm with breathing room; alternate paper/white sparingly, not as
  faint full-width stripes.
- **How it works**: a proper 3-step sequence with large numerals, a title, and a line
  each — not tiny highlighted "1/2/3" boxes.
...
- **Tiers (Scout/Shield/Arsenal)**: three tasteful cards; the "[pricing pending]"
  treatment intentional ("set on the call"), not a gap.
- **Objections ("Honest answers")**: a refined Q&A, confident, not an accordion gimmick.
- **Capture form**: single column, 4 fields, prominent submit, clear success state.

**Motion:** restrained reveal-on-scroll at most. No parallax, glassmorphism, blur,
holographic, or gradient-text.

**Imagery:** prefer typographic and light diagrammatic treatment over photos. If a
visual metaphor is used, a restrained "filing landscape / white-space map" diagram fits
the teardown (data/precision), or a tasteful light/shadow motif for the brand — never
anything astronomical, never stock photography.

---

## 4. The content, verbatim (keep this copy; restyle its presentation)

> Brand swap applied: every "Konstellation CIPO" wordmark/title/footer below now reads
> **"Shadow CIPO."** Body copy is otherwise unchanged and stays pending Will sign-off.

### Global
- Brand wordmark: **Shadow CIPO** — paired with the gloss "your behind-the-scenes Chief
  IP Officer" (at least in the hero and footer).
- Top DRAFT banner (see constraint #7).
- Nav: `Shadow CIPO` (left) · `Approach` · **`Request a teardown`** (button, right).
- Footer: "Shadow CIPO — fractional Chief IP Officer services. Led by Will Rosellini." +
  "This is a strategy and judgment service, not legal representation."

### Page: Home (`/`)
- Eyebrow: "For venture-backed founders raising or preparing to raise"
- H1 (the promise — keep substance; brand-forward draft option for the designer):
  - As-is: "Continuous IP intelligence, plus a Chief IP Officer's judgment — at a
    subscription, not by the hour."
  - Recommended brand-forward draft (pending Will): "Your Shadow CIPO: continuous IP
    intelligence and a Chief IP Officer's judgment — at a subscription, not by the hour."
...
- Proof strip: "Led by Will Rosellini" · "15 years in IP monetization" · "Raised a
  Series A himself"
- Pull-quote: "Hourly billing makes deferral the rational choice... until the bill comes
  due at the raise: a thin portfolio, a weaker round, blocking patents nobody saw."
- Credential anchors:
...
- Body: "Tell us your top competitor. We'll spend the time researching their filings and
  put a teardown together for you specifically — reviewed by a Chief IP Officer."
...
- Body: "The same continuous-intelligence model, with more room to show how the analysis
  and the judgment fit together."
- Reuses: the **How it works** 3 steps, the pull-quote, the credential anchors, the
  logo-absence line, and **Honest answers** (above).
...
- A coherent visual system expressed as **design tokens** (palette + type + spacing +
  radius above), plus
...
- [ ] Brand reads **Shadow CIPO** consistently, always glossed ("behind-the-scenes Chief
      IP Officer"), framed as capable/discreet — never covert or sinister.
...
- [ ] Responsive on mobile + desktop. Light-mode-first (dark hero OK). Restrained motion.
